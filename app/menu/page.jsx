...
const menuItems = [
  ...
  },
  {
    ...
    duration: "90分",
    price: "9500円",
    shortDescription: "お辛い箇所の集中ケアに",
    customAdjustLines: [
      "慢性的な痛みや気になる箇所のある方にオススメです",
      "お久しぶりの方にも◎",
    ],
    descriptionLines: [
      "よもぎ蒸しパッド付き",
      "整体／オイル／マグバーム／ホットストーン",
      "お身体の状態に合わせて最適な組み合わせで施術を行います",
    ],
  ...
  },
  {
    ...
    duration: "120分",
    price: "12000円",
    shortDescription: "深部まで緩ませしっかり巡りを整える",
    customAdjustLines: [
      "慢性的なコリ・ハリの深部までアプローチして緩めて流す",
      "深整コースをしっかり味わいたい方にオススメのコース◎",
    ],
    descriptionLines: [
      "整体／オイル／マグバーム／ホットストーン",
      "トークセン(深部のコリ、ハリに)",
  ...
  },
  {
    ...
    descriptionLines: [
      "アイマスク／よもぎ蒸しパッド付き",
      "body：整体・ホットストーン・マグバーム・オイル",
      "head：頭部筋膜リリース・歪み矯正・美容マスク",
      "お身体の状態に合わせて最適な組み合わせで施術を行います",
    ],
