...
const shapeCareOptions = [
  {
    ...
    minutes: 20,
    description:
      "冷え、むくみ、セルライトなどの気になる箇所を、温めたマグバームとオイルでしっかり流して柔らかく整えます。",
  },
  {
    id: "shape-2",
    name: "2部位",
    ...
    minutes: 40,
    description:
      "よりしっかりと排出を促せる”お腹＋他部位”の組み合わせがオススメです。",
  },
  {
    id: "shape-3",
    name: "3部位",
    ...
    minutes: 60,
    description:
      "脚・背中・お腹など、広い範囲をしっかり流して全身をスッキリ整えたい方におすすめです。",
  },
];
...
const headCareOption = {
  ...
  minutes: 30,
  description:
    "噛みしめ、眼精疲労、頭痛、気になるむくみやフェイスラインのたるみ、鼻づまり、眩暈、耳鳴りなどが気になる方におすすめです。マグバーム・マッサージクリームを使用し、お顔と頭蓋の骨、筋膜、筋肉にしっかりアプローチしながらも「痛みの少ない頭部ケア」を行います。",
};
...
export default function OptionMenuPage() {
  ...
  const summaryBoxStyle = {
    marginTop: "18px",
    background: "linear-gradient(180deg, #f6e3e8 0%, #f8edf0 100%)",
